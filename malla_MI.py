...
cursos = pd.read_csv("cursos/cursos_malla_MI.csv",
...
def generar_malla():
    ...
    with doc.create(TikZ(
        ...
        titulo = "Licenciatura en Ingeniería en Mantenimiento Industrial"
        fun.malla_enf(malla_MI,cursos,sesgo,MI,"MI",area_colors,titulo,rango,False)
    doc.generate_pdf(f"malla_MI", clean=True, clean_tex=False, compiler='lualatex',silent=True)
...
# datos_malla.to_csv('datos_malla_MI.csv')
# print(datos_malla)
