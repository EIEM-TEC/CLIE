...
\newline%
\begin{tabularx}{\textwidth}{p{3cm}p{13cm}}%
\par\fontsize{12}{14}\selectfont \textbf{\textcolor{parte}{6. Evaluación}}&La evaluación se distribuye en los siguientes rubros:\vspace*{1mm} \newline  \begin{itemize} \item Participación: evaluación formativa del aporte en discusiones, actividades en equipo y gestión del trabajo colaborativo. \item Pruebas cortas: evaluación formativa del conocimiento adquirido en temas clave como análisis de requisitos, modelado y evaluación de alternativas. \item Proyecto integrador: evaluación sumativa del desarrollo de un sistema de interés mediante la definición de requisitos, diseño de arquitectura, modelado y verificación en simulaciones. \end{itemize}\\%
\end{tabularx}%
\newline%
\begin{tabularx}{\textwidth}{p{3cm}p{13cm}}%
