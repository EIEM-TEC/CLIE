...
\par\hspace*{2mm}\fontsize{12}{20}\selectfont \textbf{\textcolor{parte}{1. Datos generales}}%
\vspace*{3mm}%
\newline%
...
\newline%
\begin{tabularx}{\textwidth}{p{3cm}p{13cm}}%
\par\fontsize{12}{20}\selectfont \textbf{\textcolor{parte}{3. Objetivos}}&Al final del curso la persona estudiante será capaz de:\newline%
\newline%
\textbackslash{}textbf\{Objetivo general\}\\%
\end{tabularx}%
\end{document}